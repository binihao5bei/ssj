...
class Kylin():
    ...
    def __init__(self, nowdate):
        ...
        self.urladds = [
            'http://www.kylinos.cn/about/news'
        ]
        self.url_pre = 'http://www.kylinos.cn'
    ...
    def get_data(self):
        ...
        for urladd in self.urladds:
            ...
            while (do):
                ...
                try:
                    divs = soup.find_all('div', class_='dynamic_list_con')
                except:
                    print(sys.exc_info())
                ...
                for div in divs:
                    ...
                    try:
                        ...
                        title = ('【麒麟软件】'+div.find('h4').string).replace('&','&amp;')
                        wurl = (self.url_pre + div.parent.get('href')).replace('&','&amp;')
                        wdate = div.find('h3').string
