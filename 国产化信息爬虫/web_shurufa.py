...
class Shurufa():
    ...
    def get_data(self):
        ...
        datalists=[]
        count=0
        url='https://www.baidu.com/s?ie=utf-8&medium=0&rtt=4&bsst=1&rsv_dl=news_t_sk&cl=2&wd=%E8%BE%93%E5%85%A5%E6%B3%95linux&tn=news&rsv_bp=1&rsv_sug3=2&rsv_sug1=2&rsv_sug7=000&oq=&rsv_btype=t&f=8&inputT=2972&rsv_sug4=3706&rsv_sug=1'
        response = session.get(url,headers=headers)
        soup = BeautifulSoup(response.text,'lxml')
        print('开始爬取【输入法 Linux】！')
        ...
        for div in divs:
            title = ('【输入法】'+div.find('h3',class_='news-title_1YtI1').find('a').get_text()).replace('&','&amp;')
