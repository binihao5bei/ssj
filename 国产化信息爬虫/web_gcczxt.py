...
class Gcczxt():
    ...
    def get_data(self):
        ...
        datalists=[]
        count=0
        url='https://www.baidu.com/s?ie=utf-8&medium=0&rtt=4&bsst=1&rsv_dl=news_t_sk&cl=2&wd=%E5%9B%BD%E4%BA%A7%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F&tn=news&rsv_bp=1&tfflag=0'
        ...
        for div in divs:
            title = ('【国产操作系统】'+div.find('h3',class_='news-title_1YtI1').find('a').get_text()).replace('&','&amp;')
