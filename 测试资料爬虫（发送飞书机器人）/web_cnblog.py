        ...
        for urladd in self.urladds:
            ...
            while (do):
                try:
                    ...
                    div_list = soup.find('div', class_='post-list')
                    divs = div_list.find_all('div', class_='post-item-text')
                    spans = div_list.find_all('span', class_='post-meta-item')
                ...
                for div in divs:
                    ...
                    try:
                        ...
                        wdate = spans[divs.index(div)].find('span').string.split()[0]
